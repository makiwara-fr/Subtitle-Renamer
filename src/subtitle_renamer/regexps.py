...
class Regexps:
    def __init__(self):
        ...
        self.get_season_episode = re.compile(
            "S[0-9]+E[0-9]+", flags=re.IGNORECASE
        )  # SxxExx
        self.get_odd_season_episode1 = re.compile(
            "[0-9]+x[0-9]+|[0-9]+E[0-9]+", flags=re.IGNORECASE
        )  # xxExx or --x--
        self.get_odd_season_episode2 = re.compile(
            "Season[ |\.]*[0-9]+[ |\.]+Episode[ |\.]*[0-9]+", flags=re.IGNORECASE
        )  # Season FIgure Episode Number
        ...
        self.get_odd_episode_splitter2 = re.compile(
            "[ |\.]*Episode[ |\.]*", flags=re.IGNORECASE
        )
